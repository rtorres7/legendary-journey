  ...
  <div>
    ...
    <div>
      ...
      >
        ...
        <IssueCard :issue="issues[3]" class="hidden xl:flex" />
      </div>
      <router-link
...
import IssueCard from "@studio/components/IssueCard.vue";
import LiveIssueCard from "@studio/components/LiveIssueCard.vue";
export default {
  components: {
    IssueCard,
    LiveIssueCard,
