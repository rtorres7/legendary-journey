            ...
            <div class="hidden w-[300px] md:flex flex-col">
              ...
              <ul class="px-6 space-y-3 text-slate-600">
                ...
                >
                  <div class="w-[60px] h-[60px]">
                    <img
                      src="@/shared/assets/mocks/1x1_002_military.jpg"
                      alt=""
                      class="rounded-full"
                    />
                  </div>
...
import MockProductCard from "@/domains/demo/components/MockProductCard.vue";
import MockMobileSideMenu from "@/domains/demo/components/MockMobileSideMenu.vue";
