<template>
  ...
  <template v-else-if="icon === 'bulletin'">
    <!-- https://www.svgrepo.com/svg/418372/bulletin-journal-magazine -->
    <svg
      v-bind="$attrs"
      id="Layer_1"
      fill="currentColor"
    ...
    >
      <g>
        <g>
          <path
            d="M55,21V11h-4V1H5v57c0,2.757,2.243,5,5,5h44c2.757,0,5-2.243,5-5V21H55z M10,61c-1.654,0-3-1.346-3-3V3h42v55   c0,1.125,0.373,2.164,1.002,3H10z M57,58c0,1.654-1.346,3-3,3s-3-1.346-3-3V13h2v42h2V23h2V58z"
          />
        </g>
      </g>
      <g>
  ...
  <template v-else-if="icon === 'watch'">
    <!-- https://www.svgrepo.com/svg/479826/binoculars-5 -->
    <svg
      v-bind="$attrs"
      id="_x32_"
      fill="currentColor"
    ...
    >
      <g>
        <path
          class="st0"
          d="M127.923,267.983h0.016c-3.507-0.502-6.998-0.743-10.434-0.743c-36.165,0.008-67.677,26.589-72.902,63.389
        ...
        <path
          class="st0"
          d="M510.823,324.475c-0.665-4.691-1.686-9.227-2.872-13.693l0.697-0.263c-0.007-0.024-2.547-6.758-6.51-17.517
        ...
        <path
          class="st0"
          d="M394.489,267.24c-3.437,0-6.928,0.24-10.434,0.743h0.008c-36.792,5.225-63.381,36.73-63.381,72.887
  ...
  <template v-else-if="icon === 'alert'">
    <!-- https://www.svgrepo.com/svg/310269/alert-on -->
    <svg
      v-bind="$attrs"
      id="Layer_1"
      fill="currentColor"
    ...
    >
      <g>
        <g>
          <g>
            <path
              d="M496.205,419.943L376.027,297.121c-8.304-8.486-21.938-8.56-30.333-0.165l-9.371,9.371l-31.019-30.766
            ...
            />
            <path
              d="M213.333,149.334c23.531,0,42.667-19.136,42.667-42.667s-19.136-42.667-42.667-42.667
  ...
  <template v-else-if="icon === 'tools'">
    <!-- https://www.svgrepo.com/svg/485927/tools -->
    <svg
      xmlns="http://www.w3.org/2000/svg"
      xmlns:xlink="http://www.w3.org/1999/xlink"
      v-bind="$attrs"
