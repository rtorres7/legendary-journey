export const productDetails = [
  {
    data: {
      ...
      dissem_orgs: { displayName: "Audience", values: ["ABC", "XYZ", "QRS"] },
      coordinators: {
        displayName: "Coordinators",
        values: ["ABC", "XYZ", "QRS"],
      },
      coauthors: { displayName: "Coauthors", values: ["STU", "VWX"] },
      sources: [],
      html_body:
  ...
  },
  {
    data: {
      ...
      xml_schema_ver: null,
      multimedia: false,
      producing_offices: { displayName: "Producing Offices", values: ["ABC"] },
      worldwide: true,
      ...
      dissem_orgs: { displayName: "Audience", values: ["LMN", "XYZ"] },
      coordinators: { displayName: "Coordinators", values: ["LMN", "XYZ"] },
      coauthors: { displayName: "Coauthors", values: ["STU", "VWX"] },
      sources: [],
      html_body: [
  ...
  },
  {
    data: {
      ...
      xml_schema_ver: null,
      multimedia: false,
      producing_offices: { displayName: "Producing Offices", values: ["XYZ"] },
      worldwide: true,
      ...
      dissem_orgs: { displayName: "Audience", values: ["DEF", "QRS"] },
      coordinators: { displayName: "Coordinators", values: ["DEF", "QRS"] },
      coauthors: { displayName: "Coauthors", values: ["STU", "VWX"] },
      sources: [],
      html_body: [
  ...
  },
  {
    data: {
      ...
      reporting_type_value: "analysis_all_source",
      product_image: false,
      display_title: "(U) Worldwide: COVID-19 Update as of 14 November",
    },
  },
  {
    data: {
      ...
      dissem_orgs: { displayName: "Audience", values: ["ABC", "DEF"] },
      coordinators: { displayName: "Coordinators", values: ["ABC", "DEF"] },
      coauthors: { displayName: "Coauthors", values: ["STU", "VWX"] },
      sources: [],
      html_body: [
  ...
  },
  {
    data: {
      ...
      created_at: "2023/09/01 13:00:00 -0400",
      ...
      title_sci: 0,
      summary_sci: 0,
      published_by: "Salvador Dali",
      summary: "Not much content here yet.",
      xml_schema_ver: null,
      multimedia: false,
      producing_offices: { displayName: "Producing Offices", values: ["XYZ"] },
      worldwide: true,
      updated_at: "2023-09-01T18:00:00Z",
      congress: true,
      recalled: false,
      state: "draft",
      needed: {},
      ...
      posted_at: "2023-09-019T18:00:00Z",
      posted_on: "2023/09/01",
      poc_attrib: null,
      product_type_id: 10376,
      productType: {
        code: 10376,
      ...
      attachments_metadata: [
        {
          ...
          caption: null,
          classification: "",
          created_at: "2023-09-01T13:00:00 -0400",
          document_id: 56789123,
          file_name: "WIRe001_sample_6.pdf",
          file_size: 123456,
          hide_title: true,
          id: 56789123,
          inline_height: "600px",
      ...
      poc_info: "TBD add POC Info here",
      authors: [
        {
          after_hours_phone: "4843549999",
          dn: "CN=BLOOMBERG JIM",
      ...
      reporting_type_value: "analysis_all_source",
      product_image: false,
      display_title: "(U) 01 September 2023 Current",
    },
  },
];
