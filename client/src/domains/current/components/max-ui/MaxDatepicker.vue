...
<style lang="scss">
// We're overriding the Datepicker's theme using Tailwind CSS variables. No need to use light/dark mode prop on Datepicker.
.dp__today {
  border-width: 2px;
}
...
.dp__theme_light {
  ...
  --dp-hover-color: var(--color-slate-200);
