<template>
  ...
  >
    ...
    <div class="relative items-center ml-3">
      ...
      >
        <ListboxOptions
          class="absolute w-fit py-1 mt-1 overflow-auto text-slate-900 dark:text-slate-300 energy:text-zinc-300 bg-white dark:bg-slate-700 energy:bg-zinc-600 rounded-md shadow-lg max-h-60 ring-1 ring-black ring-opacity-5 focus:outline-none z-[5]"
        >
          <ListboxOption
            v-for="item in items"
