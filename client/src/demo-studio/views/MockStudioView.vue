      ...
      <div class="flex min-h-0 flex-1">
        <div class="flex w-full">
          <div class="relative grow bg-slate-50 text-gray-900">
            <!-- Content Area -->
            <div
              class="top-0 bottom-0 flex flex-col w-full h-full items-center overflow-y-scroll"
            >
              <div
              ...
              >
                ...
                <div :class="isActivePage('#home') ? 'block' : 'hidden'">
                  ...
                  >
                    <div
                      class="text-gray-700 font-bold uppercase tracking-wider"
                    >
                      Current
                    </div>
              ...
              >
                ...
                <div :class="isActivePage('#live') ? 'block' : 'hidden'">
                  ...
                  <div class="py-8">
                    ...
                    <div
                      class="flex flex-col py-2 space-y-2 font-medium text-sm"
                    >
                  ...
                  <div
                    class="max-w-[1500px] grid grid-cols-1 xl:grid-cols-3 gap-2"
                  >
                    <template
                    ...
                    >
                      ...
                      >
                        <div
                          class="max-h-[432px] xl:max-h-[270px] cursor-pointer"
                        >
                          <img
                  ...
                  <div class="font-semibold text-gray-700 py-6">
                    More Products
                  </div>
                  <div
                  ...
                  >
                    ...
                    <div class="flex flex-col space-y-6">
                      <div>
                        ...
                        <div class="text-sm text-gray-600">
                          The top three products are shown with their
                          thumbnails.
                        </div>
                      </div>
                      <div class="flex flex-col space-y-8">
                        <div class="text-sm">
                          ...
                          <Switch
                            ...
                            :class="
                              breakingEnabled ? 'bg-blue-700' : 'bg-gray-300'
                            "
                ...
                <!-- Metrics Sample -->
                <div
                  :class="isActivePage('#issue-metrics') ? 'block' : 'hidden'"
                >
                  <div class="flex items-center justify-center min-h-[75vh]">
                    <div class="flex flex-col space-y-4">
                      <div class="text-6xl font-semibold">Coming Soon</div>
