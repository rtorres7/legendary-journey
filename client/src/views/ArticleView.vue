    ...
    >
        ...
        <Disclosure v-slot="{ open }">
          ...
          <DisclosurePanel>
            <div class="ml-4 space-y-2 text-sm">
              ...
              <p>
                <span class="font-semibold">Product Type: </span>NexCT Article
              </p>
              <p>
              ...
              <p>
                <span class="font-semibold">Posted: </span>25 Apr 2022 00:01:15
              </p>
              <p>
                <span class="font-semibold">Publication Date: </span>25 Apr 2022
              </p>
              <p>
                <span class="font-semibold">Contact: </span>(U) Produced by the
                Test
              </p>
            </div>
          </DisclosurePanel>
      ...
      <div class="flex flex-col pb-8 space-y-3 mt-10">
        ...
        >
          ...
          >
            <router-link
              :to="{ name: 'attachment', params: { url: attachment.url } }"
            >
