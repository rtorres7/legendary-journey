export const danielArticlesDetails = [
      ...
      attachments_metadata: [
        {
          ...
          file_name: "WIReWIRe_sample_.pdf",
          file_size: 123456,
          hide_title: true,
          id: 12345678,
          inline_height: "600px",
  ...
  },
  {
    data: {
      ...
      attachments_metadata: [
        {
          ...
          file_name: "WIReWIRe_sample_2.pdf",
          file_size: 123456,
          hide_title: true,
          id: 23456789,
          inline_height: "600px",
      ...
      dissem_orgs: [],
      sources: [],
      html_body: ["(U) Kyiv, Ukraine – The speed of the Ukrainian military’s counteroffensive in the eastern Kharkiv region is nothing short of breakneck.",
  ...
  },
  {
    data: {
      ...
      attachments_metadata: [
        {
          ...
          file_name: "WIReWIRe_sample_3.pdf",
          file_size: 123456,
          hide_title: true,
          id: 34567891,
          inline_height: "600px",
      ...
      dissem_orgs: [],
      sources: [],
      html_body: ["(U) Russia vowed to regain the initiative in its troubled Ukraine offensive, as it hit power plants causing blackouts across the northeast of the country after a lightning advance by Kyiv’s forces that’s reversed Moscow’s gains.",
  ...
  },
  {
    data: {
      id: "22",
      title:
        "(U) Worldwide: COVID-19 Update as of 14 November",
      classification: "U",
      ...
      attachments_metadata: [
        {
          ...
          file_name: "WIReWIRe_sample_4.pdf",
          file_size: 123456,
          hide_title: true,
          id: 45678912,
          inline_height: "600px",
      ...
      dissem_orgs: [],
      sources: [],
      html_body: ["(U) Both COVID-19 and flu vaccines have been shown to reduce illness, hospitalizations, and deaths. As flu season approaches and COVID-19 vaccine recommendations are updated, you might be wondering if you need to wait after getting a flu vaccine before getting a COVID-19 vaccine? The answer is “no!” You can get them both at the same time if you are eligible and the timing works. Experience with other vaccines has shown that immune response (the way our bodies develop protection) and possible side effects are generally the same whether you get one vaccine at a time or two.",
  ...
  },
  {
    data: {
      ...
      attachments_metadata: [
        {
          ...
          file_name: "WIReWIRe_sample_5.pdf",
          file_size: 123456,
          hide_title: true,
          id: 56789123,
          inline_height: "600px",
      ...
      dissem_orgs: [],
      sources: [],
      html_body: ["(U) Britain's King Charles III made his first speech as monarch to the British parliament on Monday before traveling to Scotland to lead the procession of his mother's coffin.",
