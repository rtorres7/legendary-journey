export const productDetails = [
  {
    data: {
      ...
      product_type_name: "WIRe Product",
  ...
  },
  {
    data: {
      ...
      summary:
        "Summary: This is a test summary description of this product. The contents of this product is coming from an product template that's published into our system. The key/value pairs of this product contain many properties that are used to determine the type of product and other valuable metadata that feeds into the rest of the system.",
      xml_schema_ver: null,
      multimedia: false,
