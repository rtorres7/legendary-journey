    ...
    "@schemas": {
      ...
      UserAlert: {
        ...
        properties: {
          ...
          title: {
            type: "string",
            description: "title varchar(100)"
          },
          message: {
            type: "string",
            description: "message varchar(4000)",
          },
          userId: {
            type: "string",
            description: "user_id int(11)",
          },
          productNumber: {
            type: "string",
            description: "document_id varchar(200)",
          },
          alertType: {
            type: "string",
            description: "alert_type varchar(20)",
            enum: ["PRODUCT_PUBLISHED"],
          },
          readState: {
            type: "string",
            description: "read_state varchar(20)",
            enum: ["READ", "UNREAD"],
          },
          eventLogId: {
            type: "string",
            description: "document_views_id varchar(20)",
          },
          meta: {
            type: "object",
            description: "",
          ...
          createdBy: {
            type: "string",
            description: "created_by_id int(11)",
          },
          createdAt: {
            type: "string",
            description: "auto generated by Schema with option { timestamps: true }",
          },
          updatedAt: {
            type: "string",
            description: "auto generated by Schema with option { timestamps: true }",
...
const endpointsFiles = ["./routes/*.js", "./routes/*.ts"];
