...
async function loadObjectStore() {
  ...
  await objectStoreService.putObject("attachments", "WIReWIRe_sample_5/article.jpg-49c59457d84d", fs.createReadStream(path.resolve("/tmp/mocks", "16x9_S003_earth.jpg")),    { "content-type": "image/jpeg"});
}
 ...
 * Route setup
 **********************************/
const { userAlertsRouter } = require("./routes/user_alerts");
