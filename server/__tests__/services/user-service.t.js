...
describe('User Service', () => {
  ...
  describe('findById', () => {
    it('should return the user with the given id', async () => {
      ...
      const originalUser = await sequelize.models.User.findOne({ where: { email: 'foo@example.com' } })
  ...
  describe('createUser', () => {
    it('should create a user with the given information', async () => {
      const savedUser = await service.createUser({ email: 'bar@example.com', dn: 'O=US,CN=bar' });
  ...
  describe('updateUser', () => {
    it('should update the given user with the given data', async () => {
      ...
      const updatedUser = await service.updateUser(originalUser.id, { firstName: 'Bob'});
  ...
  describe('deleteUser', () => {
    it('should delete a user', async () => {
      ...
      const user = await models.User.create({ email: 'to-be-deleted', dn: 'delete-me'} );
