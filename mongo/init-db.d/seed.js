...
db.articles.insertMany([
  {
    ...
    date_published: new Date("2022-09-01"),
    dissem_orgs: [],
    doc_num: "WIReWIRe_sample_1",
  ...
  },
  {
    ...
    date_published: new Date("2022-08-29"),
    dissem_orgs: [],
...
db.special_editions.drop();
db.special_editions.insertOne({
  concepts: {
    posted: [
      {
